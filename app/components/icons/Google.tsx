...
const SvgGoogle = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" fill="none" viewBox="0 0 22 20" {...props}>
    <path
      fill="#4285F4"
      fillRule="evenodd"
    ...
    <path
      fill="#FBBC05"
      fillRule="evenodd"
      d="M5.603 11.752A5.414 5.414 0 0 1 5.307 10c0-.607.107-1.198.296-1.752V5.86H2.442a9.025 9.025 0 0 0 0 8.28l3.161-2.388z"
      clipRule="evenodd"
    />
    <path
      fill="#EA4335"
