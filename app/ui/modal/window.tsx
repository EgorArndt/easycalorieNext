...
const _ModalWindow: FC<ModalWindowProps> = ({ children, ...props }: ModalWindowProps) => (
  <StyledModalWindow {...props}>
    {children}
  </StyledModalWindow>
)

export const ModalWindow = withStyles<ModalWindowProps & WithStylesProps>(_ModalWindow, null, true)