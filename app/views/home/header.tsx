import { Header } from '../../layouts/headers/primary'
import { Link, Button, Menu, MenuButton, Typography, GridGroup } from '@ui'
import { Logo } from '../../layouts/logo'
import { ArrowLeft as ArrowDown, Widget, Layers, Circle, Analytics, Airplane, Calculator} from '@icons'
...
const HomeHeader = () => {
    ...
    return (
        ...
        >
            <Menu
                ...
                menuButton={
                    ({ open }) => {
                        ...
                        return (
                            <MenuButton palette='inherit' variant='bgless' iSize={6} after={<ArrowDown style={{transform: rotation, transition: 'ease 0.3s'}} />}>
                                Features
                            </MenuButton>
                        )
                    }
            ...
            >
                <GridGroup width='100vw' borderTop borderBottom spacing={{py: 2}} palette='primary' gap='3rem' itemSize={{min: 300, max: 400}} center>
                    {[
            ...
            {[
                ...
                <Link key={txt} to={txt} fontSize='body1' palette='inherit' variant='bgless' spacing={{ml: 3}}>
                    {txt}
                </Link>
            )}
        </Header>
