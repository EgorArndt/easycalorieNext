const macrosConfig = {
  ...
  maxLength: {
    value: 3,
    message: "Up to 3 symbols are allowed for macronutrients",
  }
}
...
export const ingredientFields = [
  ...
  { label: 'Calories', id: 'calories', config: {...macrosConfig, maxLength: { value: 4, message: 'Up to 4 symbols are allowed for calories'}} },
]

export const labelFields = [
  { label: 'Custom identifiers', id: 'customIdentifiers' },
]
